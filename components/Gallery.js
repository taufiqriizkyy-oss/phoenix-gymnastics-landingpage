const photos = [
  { emoji: '🤸‍♀️', label: 'Rifda Melatih Langsung',  bg: 'bg-pink-100',   featured: true },
  { emoji: '🙌',   label: 'Sesi Handstand',           bg: 'bg-pink-50' },
  { emoji: '😄',   label: 'Momen Bahagia',            bg: 'bg-rose-50' },
  { emoji: '🤸',   label: 'Cartwheel & Roll',         bg: 'bg-pink-50' },
  { emoji: '🧘‍♀️',  label: 'Stretching Sesi',         bg: 'bg-pink-100' },
  { emoji: '👫',   label: 'Kebersamaan Tim',          bg: 'bg-rose-50' },
